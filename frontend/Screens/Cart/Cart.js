...
const Cart = () => {
  ...
  const renderItem = ({ item, index }) => (
    <TouchableHighlight _dark={{ bg: "coolGray.800" }} _light={{ bg: "white" }}>
      <Box pl="4" pr="5" py="2" bg="white" keyExtractor={(item) => item.id}>
        <HStack alignItems="center" space={3}>
          ...
          >
            ...
            {/* Updated to show price multiplied by quantity */}
          </Text>
        </HStack>
        <HStack>
          <TouchableOpacity
  ...
  return (
    <>
      ...
      >
        ...
        <HStack justifyContent="space-between">
          <EasyButton
          medium onPress={goCheckout}  style={{ backgroundColor: "black" }}>
